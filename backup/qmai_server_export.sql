...
CREATE TABLE `ai_analysis_results` (
  ...
  `analysis_type` enum('risk','detection','prediction','root_cause','optimization') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ai_models` (
  ...
  `status` enum('training','deployed','archived','failed') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ai_warnings` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `warning_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `severity` enum('info','warning','critical') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `audit_findings` (
  ...
  `finding_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'conformity/non_conformity/opportunity',
  `severity` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'major/minor',
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `evidence` text COLLATE utf8mb4_unicode_ci COMMENT '客观证据',
  `requirement_ref` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '引用标准条款',
  `status` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open' COMMENT 'open/rectifying/verified/rejected/closed',
...
CREATE TABLE `audits` (
  ...
  `audit_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'internal/process/product',
  ...
  `status` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'planned' COMMENT 'planned/in_progress/completed/archived',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `capa` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `capa_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `defect_id` bigint DEFAULT NULL,
  `anomaly_id` bigint DEFAULT NULL,
  `complaint_id` bigint DEFAULT NULL,
  `severity` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'major',
  `title` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `capa_root_causes` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `capa_id` bigint NOT NULL,
  `analysis_method` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'five_whys',
  `content` json NOT NULL COMMENT '5Why问答或鱼骨图数据',
  `root_cause_summary` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_by` bigint NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `capa_id` (`capa_id`),
...
CREATE TABLE `capa_verifications` (
  ...
  `conclusion` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'effective/not_effective/requires_revision',
...
CREATE TABLE `closure_rules` (
  ...
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规则编码',
  `condition_json` json NOT NULL COMMENT '条件表达式JSON',
  `logic` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT 'AND' COMMENT '逻辑运算符 AND/OR',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '描述',
...
CREATE TABLE `complaint_events` (
  ...
  `event_data` text COLLATE utf8mb4_unicode_ci COMMENT '事件数据（JSON）',
...
CREATE TABLE `complaints` (
  ...
  `subject` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '投诉主题',
  `description` text COLLATE utf8mb4_unicode_ci,
  `severity` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'critical/major/minor',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'new' COMMENT 'new/acknowledged/in_progress/closed',
...
CREATE TABLE `d8_reports` (
  ...
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'd0' COMMENT 'd0/d1/d2/d3/d4/d5/d6/d7/d8',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `defect_codes` (
  ...
  `defect_category` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `defect_severity` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'CR/MA/MI',
  `description` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `defects` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `defect_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '缺陷编码',
  `severity` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'major' COMMENT 'critical/major/minor',
  `source_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'iqc/ipqc/fqc/oqc/customer',
  ...
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open' COMMENT 'open/investigating/resolved/closed',
  `org_id` bigint DEFAULT NULL COMMENT '所属组织',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `document_versions` (
  ...
  `minio_key` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `change_description` text COLLATE utf8mb4_unicode_ci COMMENT '变更说明',
  `created_by` bigint NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `documents` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `title` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `doc_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'sop/work_instruction/inspection_standard/8d_report/audit_report/other',
  `minio_key` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'MinIO对象键',
  `file_size_bytes` bigint DEFAULT NULL COMMENT '文件大小（字节）',
  `file_hash` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SHA-256哈希',
  `version` int NOT NULL DEFAULT '1',
  `status` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft' COMMENT 'draft/reviewing/approved/archived',
  `approved_by` bigint DEFAULT NULL COMMENT '审批人ID',
  `rejection_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '驳回理由',
...
CREATE TABLE `dynamic_params` (
  ...
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '参数名',
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '参数编码(唯一)',
  `data_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'numeric' COMMENT '数据类型: numeric/categorical/boolean',
...
CREATE TABLE `equipment` (
  ...
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'idle' COMMENT 'running/idle/fault/maintenance',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `equipment_param_mappings` (
  ...
  `mqtt_topic` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `system_param_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `param_group_id` bigint DEFAULT NULL COMMENT '关联参数组ID',
  `data_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'numeric' COMMENT 'numeric/count/status',
  `unit` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `fqc_inspection_items` (
  ...
  `item_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '检验项目名称',
  `item_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '检验项目编码',
  `data_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'numeric' COMMENT '数据类型',
  ...
  `result` enum('pending','pass','fail') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `image_urls` text COLLATE utf8mb4_unicode_ci COMMENT '图片URLs (JSON)',
  PRIMARY KEY (`id`),
...
CREATE TABLE `fqc_inspections` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `inspection_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `inspection_type` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'full/sampling',
  `conclusion` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'pending' COMMENT 'qualified/unqualified/pending',
...
CREATE TABLE `inspection_items` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `item_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '检验项目编码',
  `item_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '检验项目名称',
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '描述',
  `data_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'numeric' COMMENT '数据类型: numeric/visual/attribute',
  ...
  `data_collection_param_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '数采参数编码(关联dynamic_params.code)',
  `chart_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '控制图类型: none/Xbar_R/Xbar_S/I_MR/P/U/C',
  `subgroup_size` int DEFAULT NULL COMMENT '默认子组大小(SPC用)',
  `inspection_method` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '检验方法/工具',
...
CREATE TABLE `inspection_plans` (
  ...
  `plan_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '计划名称',
  `inspection_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '检验类型: IQC/IPQC/FQC/OQC',
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '描述',
...
CREATE TABLE `inspection_standards` (
  ...
  `inspection_type` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'IQC/IPQC/FQC/OQC',
  ...
  `unit` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '单位',
  `sampling_method` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sampling_frequency` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '抽样频率',
  `aql` decimal(5,2) DEFAULT NULL,
  `inspection_level` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ipqc_ai_risk_scores` (
  ...
  `risk_level` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'normal' COMMENT '风险等级：normal/warning/critical',
  `factors_json` text COLLATE utf8mb4_unicode_ci COMMENT '风险因素分解 (JSON)',
  `trend_direction` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '趋势方向：stable/rising/falling',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `ipqc_closure_status` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `work_order` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ipqc_first_pieces` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `fp_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` bigint DEFAULT NULL,
  `process_id` bigint DEFAULT NULL,
  `equipment_id` bigint DEFAULT NULL,
  `work_order` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `batch_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `org_id` bigint DEFAULT NULL COMMENT '所属组织',
  `inspector` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `conclusion` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'pending' COMMENT '结论：pass/fail/pending',
  `reason` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '不合格原因',
  `shift` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '班次',
...
CREATE TABLE `ipqc_patrol_items` (
  ...
  `item_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '检验项目名称',
  `item_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '检验项目编码',
  `data_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'numeric' COMMENT '数据类型',
  `usl` decimal(12,4) DEFAULT NULL COMMENT '规格上限',
  `lsl` decimal(12,4) DEFAULT NULL COMMENT '规格下限',
  `actual_value` decimal(12,4) DEFAULT NULL COMMENT '实测值',
  `result` enum('pass','fail','pending') COLLATE utf8mb4_unicode_ci DEFAULT 'pending' COMMENT '结果',
  `image_urls` text COLLATE utf8mb4_unicode_ci COMMENT '图片URLs (JSON)',
  PRIMARY KEY (`id`),
...
CREATE TABLE `ipqc_patrol_plans` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `plan_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `equipment_id` bigint DEFAULT NULL,
  `process_id` bigint DEFAULT NULL,
  `org_id` bigint DEFAULT NULL COMMENT '所属组织',
  `interval_minutes` int DEFAULT NULL,
  `inspector` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'active' COMMENT 'active/paused/completed',
  PRIMARY KEY (`id`),
...
CREATE TABLE `ipqc_patrols` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `patrol_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `iqc_anomalies` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `anomaly_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `anomaly_type` enum('quality','quantity','document','packaging','environment','other') COLLATE utf8mb4_unicode_ci DEFAULT 'quality' COMMENT '异常类型',
  `severity` enum('critical','major','minor') COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `isolated_inventory` decimal(15,2) DEFAULT '0.00' COMMENT '隔离库存量',
  `disposition` enum('none','return','concession','rework','special_purchase') COLLATE utf8mb4_unicode_ci DEFAULT 'none' COMMENT '处置方式',
  `disposition_by` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处置决定人',
  `disposition_date` datetime DEFAULT NULL COMMENT '处置决定时间',
  `handler_dept` enum('quality','purchasing','engineering','production','other') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处理人部门',
  `status` enum('open','quarantined','investigating','mrb_reviewing','mrb_approved','disposed','processing','resolved','closed') COLLATE utf8mb4_unicode_ci DEFAULT 'open' COMMENT '状态',
  `handler` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mrb_reviewed` tinyint(1) DEFAULT '0' COMMENT 'MRB 评审是否完成',
  `mrb_reviewer` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'MRB 评审人',
...
CREATE TABLE `iqc_inspection_items` (
  ...
  `inspection_item_id` bigint DEFAULT NULL COMMENT '关联检验项目主数据',
  `item_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '检验项目名称（冗余）',
  `measured_value` decimal(12,4) DEFAULT NULL,
  `usl` decimal(12,4) DEFAULT NULL COMMENT '规格上限',
  `lsl` decimal(12,4) DEFAULT NULL COMMENT '规格下限',
  `result` enum('pass','fail') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `iqc_inspections` (
  ...
  `sampling_level` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '抽样水平',
  `aql_value` decimal(5,2) DEFAULT NULL COMMENT 'AQL值',
  `org_id` bigint DEFAULT NULL COMMENT '所属组织',
  `result` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT 'pending' COMMENT 'pending/pass/fail/scrap',
  `inspector` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `iqc_receipts` (
  ...
  `org_id` bigint DEFAULT NULL COMMENT '所属组织',
  `inspector` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'pending' COMMENT 'pending/inspecting/completed/anomaly',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `oqc_releases` (
  ...
  `release_number` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '放行单号（唯一）',
  ...
  `e_signature_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '电子签名URL（MinIO）',
  `signature_time` datetime DEFAULT NULL COMMENT '签名时间',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'pending/signed/released/cancelled',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `organizations` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '组织编码',
  `name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '组织名称',
  `level` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '层级：group/company/workshop/line',
  `parent_id` bigint DEFAULT NULL COMMENT '父级组织 ID',
  `sort_order` int DEFAULT '0' COMMENT '排序号',
  `is_active` tinyint(1) DEFAULT '1' COMMENT '是否启用',
  `location` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '位置/地址',
  `contact` text COLLATE utf8mb4_unicode_ci COMMENT '联系人信息 (JSON)',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '描述',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` bigint DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE `packaging_confirmations` (
  ...
  `packaging_method` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '包装方式',
...
CREATE TABLE `param_groups` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '组名',
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '组编码',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '描述',
  `sort_order` int DEFAULT '0' COMMENT '排序号',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `param_realtime_values` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `param_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '参数编码',
  `equipment_id` bigint DEFAULT NULL COMMENT '设备ID',
  `value` decimal(15,6) DEFAULT NULL COMMENT '数值(数值型)',
  `value_raw` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '原始值(枚举型/布尔型)',
  `timestamp` datetime NOT NULL COMMENT '采集时间',
  `quality_result` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT 'UNKNOWN' COMMENT '质量结果 OK/NG/UNKNOWN',
  PRIMARY KEY (`id`),
...
CREATE TABLE `processes` (
  ...
  `process_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `department` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属部门/车间（显示冗余）',
  `org_id` bigint DEFAULT NULL COMMENT '所属组织',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `product_batches` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `batch_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '批次编号（LOT-YYYYMMDD-X）',
  `source` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'manual' COMMENT '来源：manual / ipqc-auto / work-order',
  `product_id` bigint NOT NULL COMMENT '关联产品',
  `work_order_id` bigint DEFAULT NULL COMMENT '关联工单',
  `quantity` decimal(18,4) NOT NULL DEFAULT '0.0000' COMMENT '数量',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'in_progress' COMMENT 'in_progress/inspected/released/quarantined',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `products` (
  ...
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '产品描述',
  `product_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '产品类别',
  `specification` text COLLATE utf8mb4_unicode_ci,
  `unit` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_inspection_level` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT 'II',
...
CREATE TABLE `routing_headers` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `product_id` bigint NOT NULL COMMENT '关联产品',
  `route_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工艺路线编码',
  `route_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工艺路线名称',
  `route_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'STD' COMMENT '类型',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '描述',
...
CREATE TABLE `routing_steps` (
  ...
  `process_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `workcenter` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `routings` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `routing_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工艺路线编号（同一路线多步骤共享）',
  `routing_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工艺路线名称',
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工艺路线描述',
...
CREATE TABLE `scrap_rework_records` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'scrap/rework',
  `defect_id` bigint DEFAULT NULL,
  `batch_id` bigint DEFAULT NULL,
  `quantity` decimal(15,2) NOT NULL,
  ...
  `rework_inspection_result` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
...
CREATE TABLE `spc_analysis_results` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `chart_id` bigint NOT NULL,
  `analysis_type` enum('cpk','ppk','capability') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `spc_anova_results` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `chart_id` bigint NOT NULL,
  `source` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'operator/machine/material/method/environment',
...
CREATE TABLE `spc_control_charts` (
  ...
  `process_id` bigint NOT NULL,
  `parameter_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `chart_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Xbar_R / Xbar_S / I_MR',
...
CREATE TABLE `spc_data_sources` (
  ...
  `source_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '数据源类型: IQC/IPQC/FQC',
...
CREATE TABLE `supplier_scores` (
  ...
  `grade` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评级：A/B/C/D',
  `evaluation` text COLLATE utf8mb4_unicode_ci COMMENT '评估意见',
  PRIMARY KEY (`id`),
...
CREATE TABLE `suppliers` (
  ...
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` text COLLATE utf8mb4_unicode_ci,
  `rating` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '供应商等级：A/B/C/D',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'active' COMMENT 'active/inactive/blacklisted',
  `supply_category` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '供应产品类别',
  `org_id` bigint DEFAULT NULL COMMENT '所属组织',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `sys_dict_items` (
  ...
  `item_label` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '显示标签',
  `item_value` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '选项值',
  `sort_order` int DEFAULT '0' COMMENT '排序号',
...
CREATE TABLE `sys_dict_types` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `type_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '字典类型编码',
  `type_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '字典类型名称',
...
CREATE TABLE `tools` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tool_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tool_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `model` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工具型号',
  `tool_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `design_life` decimal(10,2) DEFAULT NULL COMMENT '设计寿命',
  `life_unit` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'cycles' COMMENT '寿命单位',
  ...
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'active' COMMENT 'active/worn/broken/retired',
  `equipment_id` bigint DEFAULT NULL,
  `org_id` bigint DEFAULT NULL COMMENT '所属组织',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `trace_records` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `trace_no` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_id` bigint DEFAULT NULL,
  `batch_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sn` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `trace_type` enum('sn','batch','equipment','tool') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping events for database 'qmai'
--
...
-- Dump completed on 2026-07-30  6:15:19

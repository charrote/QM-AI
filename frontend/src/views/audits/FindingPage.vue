...
<template>
  <div class="page-container">
    ...
    <div class="toolbar-row">
      ...
      />
      <el-select v-model="findingTypeFilter" placeholder="发现类型" clearable style="width: 130px" @change="loadFindings">
        <el-option v-for="opt in FINDING_TYPE_OPTIONS" :key="opt.value" :label="opt.label" :value="opt.value" />
      </el-select>
      <el-select v-model="statusFilter" placeholder="状态" clearable style="width: 130px" @change="loadFindings">
        <el-option v-for="opt in FINDING_STATUS_OPTIONS" :key="opt.value" :label="opt.label" :value="opt.value" />
      </el-select>
      <el-button type="primary" @click="openCreate">+ 新建不符合项</el-button>

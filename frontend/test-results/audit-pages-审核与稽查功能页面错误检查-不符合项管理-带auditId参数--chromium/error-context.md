...
- Name: audit-pages.spec.ts >> 审核与稽查功能页面错误检查 >> 不符合项管理 (带auditId参数)
- Location: tests/audit-pages.spec.ts:424:3
...
> 427 |     await page.goto('/login', { waitUntil: 'domcontentloaded', timeout: 15000 })
  ...
  493 |         }
  494 |       }
  495 |       fs.writeFileSync(reportPath, report)
  496 |       console.log(`详细错误报告已保存至: ${reportPath}`)
  497 |     }
  498 |   })
  499 | })
  500 | 
